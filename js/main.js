...
--------------------------------------------------*/
    ...
    $('.owl-carousel').owlCarousel({
        ...
        lazyLoad: true,
        nav:true,
        navText: ['<div class="testimonial-slider-btn effect hor-center"><i class="fa fa-angle-left center"></i></div>','<div class="testimonial-slider-btn effect hor-center"><i class="fa fa-angle-right center"></i></div>'],
        responsive:{
            0:{
                items:1,
                stagePadding: 60
...
--------------------------------------------*/
    ...
    if (animation) {
      ...
      var text = $('#home .typer-title'),
          textOne = "i'm a spatial data scientist",
          textTwo = "i'm a full stack webgis developer",
          textThree = "i like to brighten up people's life with geospatial intelligence",
          textFour = "let's make the world a better place";
